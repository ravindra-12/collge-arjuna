...
<head>
    ...
    <title>Privacy Policy - Collgearjuna</title>
...
<body class="stretched">
    ...
    <div class="container privacy-policy">
        ...
        <div class="content-section">
            <p>The website www.collgearjuna.com is developed and operated by M/s Astarrite Education Private Limited, a company incorporated under the Companies Act, 2013. If you require any more information or have any questions about our privacy policy, please feel free to contact us by email at <a href="mailto:contact@collgearjuna.com">contact@collgearjuna.com</a>.</p>
        </div>
        <div class="content-section">
            <b>At collgearjuna.com, the privacy of our visitors is of extreme importance to us. This privacy policy document outlines the types of personal information is received and collected by collgearjuna.com and how it is used.</b>
        </div>
        <div class="content-section">
            <h3>Log Files</h3>
            <p>Like many other websites, collgearjuna.com makes use of log files. The information inside the log files includes internet protocol (IP) addresses, type of browser, Internet Service Provider (ISP), date/time stamp, referring/exit pages, and number of clicks to analyze trends, administer the site, track user’s movement around the site, and gather demographic information. IP addresses, and other such information are not linked to any information that is personally identifiable.</p>
        </div>
        <div class="content-section">
            <h3>Cookies and Web Beacons</h3>
            <p>collgearjuna.com does use cookies to store information about visitors' preferences, record user-specific information on which pages the user access or visit, customize Web page content based on visitors' browser type or other information that the visitor sends via their browser.</p>
        </div>
        <div class="content-section">
            <h3>DoubleClick DART Cookie</h3>
            <ul>
                <li>Google, as a third party vendor, uses cookies to serve ads on collgearjuna.com.</li>
                <li>Google’s use of the DART cookie enables it to serve ads to users based on their visit to collgearjuna.com and other sites on the Internet.</li>
            ...
            <p>Our advertising partners may use cookies and web beacons on our site. Our advertising partners include Google Adsense. They automatically receive your IP address for every ad request. Other technologies (such as cookies, JavaScript, or Web Beacons) may also be used by the third-party ad networks to measure the effectiveness of their advertisements and/or to personalize the advertising content that you see.</p>
            <p>collgearjuna.com has no access to or control over these cookies that are used by third-party advertisers. You should consult the respective privacy policies of these third-party ad servers for more detailed information on their practices as well as for instructions about how to opt-out of certain practices. collgearjuna.com’s privacy policy does not apply to, and we cannot control the activities of, such other advertisers or web sites.</p>
            <p>To see how Google uses this data, go here: <a href="http://www.google.com/policies/privacy/partners/" target="_blank">http://www.google.com/policies/privacy/partners/</a></p>
        ...
        <div class="content-section">
            ...
            <ul>
                <li><a href="https://www.collgearjuna.com/contact-us/" target="_blank">https://www.collgearjuna.com/contact-us/</a></li>
                <li><a href="mailto:contact@collgearjuna.com">contact@collgearjuna.com</a></li>
            </ul>
        </div>
    </div>
</div>
